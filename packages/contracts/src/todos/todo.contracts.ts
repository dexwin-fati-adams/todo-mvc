...
//       .optional(),
//       //corce javastricpt a type from  a string to a number and validate it as an integer with a minimum value of 1. If the page parameter is omitted, it defaults to 1. Similarly, the pageSize parameter is coerced to a number,
//       //  validated as an integer with a minimum value of 1 and a maximum value of 100, and defaults to 20 if omitted.
//     page: z.coerce.number().int().min(1).default(1),
//     //pageSize is the number of items to return per page. It is coerced to a number, validated as an
//     //  integer with a minimum value of 1 and a maximum value of 100, and defaults to 20 if omitted.
